...
def get_normal_test(means, quats, scales, viewmat):
    ...
    gt_normal_global = torch.load("/home/ubuntu/PGSR/normal_global.pth", weights_only=True).to(device="cuda")
    ...
    gt_gaussian_to_cam_global = torch.load("/home/ubuntu/PGSR/gaussian_to_cam_global.pth", weights_only=True).to(device="cuda")
    # gt_neg_mask = torch.load("/home/ubuntu/PGSR/neg_mask.pth", weights_only=True).to(device="cuda")
...
def compute_all_map_with_test(means, quats, scales, viewmat):
    ...
    gt_global_normal = torch.load("/home/ubuntu/PGSR/global_normal.pth", weights_only=True).to(device="cuda")
    gt_local_normal = torch.load("/home/ubuntu/PGSR/local_normal.pth", weights_only=True).to(device="cuda")
    gt_pts_in_cam = torch.load("/home/ubuntu/PGSR/pts_in_cam.pth", weights_only=True).to(device="cuda")
    gt_depth_z = torch.load("/home/ubuntu/PGSR/depth_z.pth", weights_only=True).to(device="cuda")
    gt_local_distance = torch.load("/home/ubuntu/PGSR/local_distance.pth", weights_only=True).to(device="cuda")
    gt_input_all_map = torch.load("/home/ubuntu/PGSR/input_all_map.pth", weights_only=True).to(device="cuda")
...
def load_initial_params(path = "/home/ubuntu/PGSR", prefix="render_"):
...
viewmat = torch.load("/home/ubuntu/PGSR/world_view_transform.pth", weights_only=True).to(device="cuda")
...
#
# input_all_map_gt = torch.load(f"/home/ubuntu/PGSR/input_all_map.pth", weights_only=True).to(device="cuda")
#
...
pgsr_rendered_normal = torch.load("/home/ubuntu/PGSR/rendered_normal.pth", weights_only=True).to(device="cuda")
pgsr_rendered_alpha = torch.load("/home/ubuntu/PGSR/rendered_alpha.pth", weights_only=True).to(device="cuda")
pgsr_rendered_distance = torch.load("/home/ubuntu/PGSR/rendered_distance.pth", weights_only=True).to(device="cuda")
pgsr_plane_depth = torch.load("/home/ubuntu/PGSR/plane_depth.pth", weights_only=True).to(device="cuda")
pgsr_depth_normal = torch.load("/home/ubuntu/PGSR/depth_normal.pth", weights_only=True).to(device="cuda")

...
from .utils import depth_to_normal, get_projection_matrix, get_normal
...
def rasterization(
    ...
    if colors.shape[-1] > channel_chunk:
        ...
        render_colors, render_alphas, render_planes, render_depths = [], [], [], []
        for i in range(n_chunks):
            ...
            if with_eval3d:
                ...
                assert means2d is not None
                render_colors_, render_alphas_, render_planes_, render_depths_ = rasterize_to_pixels(
                    means2d,
                    conics,
                    colors_chunk,
                    opacities,
            ...
            render_planes.append(render_planes_)
            render_depths.append(render_depths_)

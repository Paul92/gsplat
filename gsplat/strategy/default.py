...
class DefaultStrategy(Strategy):
    ...
    Args:
        ...
        prune_sens_base (float): Base percentage for GS pruning based on the Sensitivity Score.
          GSs with sensitivity below or equal to prune_sens_base * prune_sens_decay ^ (step / 1000)
          percent will be pruned. Default is 0.03.
        prune_sens_decay (float): Percentile decay for GS pruning based on the Sensitivity
